...
public class Sudoku extends LatinSquare {
	...
	private void FillDiagonalRegions() {
		...
		while(N<iSize) {
			this.SetRegion​(N);
			this.ShuffleRegion​(N);
			N = N+iSqrtSize+1;
		}
	}
	public void fortest_FillDiagonalRegions() {
		this.FillDiagonalRegions();
	}
	private void SetRegion​(int r) {
		int p = 0;
		int [][] B = this.getPuzzle();
		int [] C = new int [iSize];
		int[] R =  this.getRegion(r);
		while(p < iSize) {
			C[p] = p+1;
			p++;
		}
		int n = 0;
		int H = (r%iSqrtSize)*iSqrtSize;
		int L = (r%iSqrtSize)*iSqrtSize;
		...
		super.setLatinSquare(B);
	}
	
	public void fortest_setRegion(int r) {
		this.SetRegion​(r);
	}
	private void ShuffleRegion​(int r) {
		int [] R = getRegion(r);
		int [][] A = this.getPuzzle();
		...
		super.setLatinSquare(A);
	}
	public void fortest_ShuffleRegion1​(int r) {
	...
	public void fortest_shuffleArray1(int[] ar) {
